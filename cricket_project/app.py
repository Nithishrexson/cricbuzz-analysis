...
@st.cache_data
def load_data():
    matches = pd.read_csv("cricket_project/data/cricbuzz_matches.csv")
    teams = pd.read_csv("cricket_project/data/teams.csv")
    series = pd.read_csv("cricket_project/data/series.csv")
